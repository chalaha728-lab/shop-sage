    ...
    return (
      <div className='w-full'>
        ...
        <textarea
          ...
          id={textareaId}
          className={cn(
            'w-full rounded-lg border px-4 py-2.5 text-sm placeholder:text-secondary-400 focus:outline-none focus:ring-2 focus:ring-primary-500/20 transition-colors resize-y min-h-[100px]',
            error
